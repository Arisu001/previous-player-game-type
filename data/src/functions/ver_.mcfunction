...
tellraw @a [{"text": "═══════[ ", "color": "#19df5", "bold": true}, {"text": "previousPlayerGameType", "color": "light_purple"}, {"text": " ]═══════"}]
tellraw @a ""
...
tellraw @a ""
tellraw @a [{"text": "Created by", "color": "gray"}, {"text": ": ", "color": "yellow"}, {"text": "Arisu001", "color": "gold"}]
tellraw @a ""
tellraw @a ""
